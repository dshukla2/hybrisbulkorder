...
import com.bulkorder.test.events.TestEventListenerCountingEvents;
...
public class FraudCheckIntegrationTest extends ServicelayerTest
{
	...
	/**
	 * Load bean definition from bulkorderprocess-spring-test-fraudcheck.xml
	 */
	@BeforeClass
	public static void beforeClass()
	{
		...
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/bulkorderprocess/test/bulkorderprocess-spring-test-fraudcheck.xml"));
	...
	protected static final String PARAM_NAME_MIN_PERIOD_WAITING_FOR_CLEANUP_IN_SECONDS = "bulkorderprocess.fraud.minPeriodWaitingForCleanUpInSeconds";
	protected static final String PARAM_NAME_FRAUD_SCORE_LIMIT = "bulkorderprocess.fraud.scoreLimit";
	protected static final String PARAM_NAME_FRAUD_SCORE_TOLERANCE = "bulkorderprocess.fraud.scoreTolerance";
	...
	public void before() throws Exception
	{
		...
		{
			importCsv("/bulkorderprocess/test/testTicketEssentialData.csv", "utf-8");
		}
		importCsv("/bulkorderprocess/test/testWarehouses.csv", "utf-8");
	...
	{
		final String processDefinitionName = BulkorderprocessConstants.ORDER_PROCESS_NAME;
	...
	protected String submitOrderMock(final OrderModel order)
	{
		final OrderProcessModel businessProcessModel = (OrderProcessModel) businessProcessService.createProcess(
				BulkorderprocessConstants.ORDER_PROCESS_NAME + order.getCode() + +System.currentTimeMillis(),
				BulkorderprocessConstants.ORDER_PROCESS_NAME);
