 ...
 */
package com.bulkorder.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(BulkorderprocessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(BulkorderprocessConstants.PARENT_PROCESS);
