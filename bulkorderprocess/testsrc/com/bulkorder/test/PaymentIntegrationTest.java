...
import com.bulkorder.test.actions.TestActionTemp;
...
public class PaymentIntegrationTest extends ServicelayerTest
{
	...
	public static void prepare() throws Exception
	{
		...
		xmlReader.loadBeanDefinitions(
				new ClassPathResource("/bulkorderprocess/test/bulkorderprocess-spring-test.xml"));
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/bulkorderprocess/test/bulkorderprocess-spring-test-fraudcheck.xml"));
		xmlReader
				.loadBeanDefinitions(new ClassPathResource("/bulkorderprocess/test/process/order-process-spring.xml"));
		...
		definitonFactory.add("classpath:/bulkorderprocess/test/process/payment-process.xml");
	...
	public void setUpProductCatalogue()
	{
		try
		{
			...
			importCsv("/bulkorderprocess/test/testBasics.csv", "windows-1252");
			importCsv("/bulkorderprocess/test/testCatalog.csv", "windows-1252");
	...
	public static void removeProcessDefinitions()
	{
		...
		final XmlBeanDefinitionReader xmlReader = new XmlBeanDefinitionReader((BeanDefinitionRegistry) beanFactory);
		xmlReader.loadBeanDefinitions(
				new ClassPathResource("/bulkorderprocess/test/bulkorderprocess-spring-testcleanup.xml"));
